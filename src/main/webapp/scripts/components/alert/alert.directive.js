        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('algotimizacaoApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-algotimizacaoApp-error');
                                var entityKey = httpResponse.headers('X-algotimizacaoApp-params');
                                if (errorHeader) {
